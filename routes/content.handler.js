...
router.get('/search', async (req, res) => {
  const [watchlist] = await sequelize.query(
    'SELECT distinct Contents.* from Contents, ContentGenre WHERE Contents.Id = ContentGenre.ContentId and ContentTypeId = 1 and (ContentGenre.GenreId = 3 or ContentGenre.GenreId = 4)',
  );
